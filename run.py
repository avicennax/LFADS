...
if __name__ == "__main__":
    ...
    parser.add_argument('--g-hidden-dim', type=int, default=32, help='Dimension of generator state')
    ...
    parser.add_argument('--neuron-dim', type=int, default=30, help='Number of observed neurons')
    parser.add_argument('--factor-dim', type=float, default=3, help='Latent factor dimension')
    parser.add_argument('--infered-input-dim', type=int, default=8, help='Dimension of infered inputs generated by decoder')
    parser.add_argument('--generator-dim', type=int, default=32, help='Dimension of generator vector')
    parser.add_argument('--encoder-hidden-dim', type=int, default=16, help='Dimension of forwards/backwards encoder')
    parser.add_argument('--dropout-keep-p', type=float, default=0.9, help='Dropout keep probability')
    parser.add_argument('--kl-prior-var', type=float, default=0.1, help='Variance of symmetric MVG prior over latent variables')
    parser.add_argument('--state-clip-value', type=float, default=5.0, help='Maximum value for RNN states for clipping')
    parser.add_argument('--max-norm', type=float, default=50, help='Gradient clipping norm')
